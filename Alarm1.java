/**This class is implemented off of Alarm Clock for 12 hour time.
 * METHOD LIST:
 * setAlarmTime()
 * snooze()
 * getAlarmTime()
 ...
 * ring()
  */
class Alarm1 implements AlarmClock{
    /**
     ...
     */
    public Alarm1(int hour, int minute){
        this.hour = hour;
        this.minute = minute;
        alarmHour = 6;
        alarmMinute = 00; 
    ...
    public void setAlarmTime(int newHour, int newMinute){
        if (newHour <= 12 && (newMinute >= 0 && newMinute <= 59)){
            alarmHour = newHour;
